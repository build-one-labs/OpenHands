...
export enum I18nKey {
  ...
  CHAT_INTERFACE$AGENT_WORKING = "CHAT_INTERFACE$AGENT_WORKING",
  ...
  LANDING$SUBTITLE_PROMPT = "LANDING$SUBTITLE_PROMPT",
  ...
  SERVED_APP$PREVIEW_LABEL = "SERVED_APP$PREVIEW_LABEL",
  ...
  GIT$CLEAR_TOKEN = "GIT$CLEAR_TOKEN",
  ...
  HOME$CONNECT_TO_ENVIRONMENT = "HOME$CONNECT_TO_ENVIRONMENT",
  HOME$CONNECT_TO_ENVIRONMENT_DESCRIPTION = "HOME$CONNECT_TO_ENVIRONMENT_DESCRIPTION",
  HOME$ENVIRONMENT_URL_LABEL = "HOME$ENVIRONMENT_URL_LABEL",
  HOME$ENVIRONMENT_URL_REQUIRED = "HOME$ENVIRONMENT_URL_REQUIRED",
  HOME$ENVIRONMENT_URL_INVALID = "HOME$ENVIRONMENT_URL_INVALID",
  HOME$ENVIRONMENT_URL_INVALID_SCHEME = "HOME$ENVIRONMENT_URL_INVALID_SCHEME",
  HOME$ENVIRONMENT_CONVERSATION_ID_LABEL = "HOME$ENVIRONMENT_CONVERSATION_ID_LABEL",
  HOME$CONNECT = "HOME$CONNECT",
  HOME$CONNECTING = "HOME$CONNECTING",
  HOME$NO_MATCHING_ENVIRONMENTS = "HOME$NO_MATCHING_ENVIRONMENTS",
  ...
  MCPS_MODAL$TITLE = "MCPS_MODAL$TITLE",
  CONVERSATION$SHOW_MCPS = "CONVERSATION$SHOW_MCPS",
  ...
  AUTH$ENTER_PASSWORD_TO_CONTINUE = "AUTH$ENTER_PASSWORD_TO_CONTINUE",
  AUTH$INVALID_PASSWORD = "AUTH$INVALID_PASSWORD",
  AUTH$SIGN_IN = "AUTH$SIGN_IN",
  AUTH$SIGNING_IN = "AUTH$SIGNING_IN",
  AUTH$SIGN_UP = "AUTH$SIGN_UP",
  AUTH$SIGN_IN_TO_CONTINUE = "AUTH$SIGN_IN_TO_CONTINUE",
  AUTH$CREATE_ACCOUNT = "AUTH$CREATE_ACCOUNT",
  AUTH$EMAIL_PLACEHOLDER = "AUTH$EMAIL_PLACEHOLDER",
  AUTH$NAME_PLACEHOLDER = "AUTH$NAME_PLACEHOLDER",
  AUTH$INVALID_CREDENTIALS = "AUTH$INVALID_CREDENTIALS",
  AUTH$SIGN_UP_FAILED = "AUTH$SIGN_UP_FAILED",
  AUTH$OAUTH_FAILED = "AUTH$OAUTH_FAILED",
  AUTH$ALREADY_HAVE_ACCOUNT = "AUTH$ALREADY_HAVE_ACCOUNT",
  AUTH$DONT_HAVE_ACCOUNT = "AUTH$DONT_HAVE_ACCOUNT",
  AUTH$OR_CONTINUE_WITH = "AUTH$OR_CONTINUE_WITH",
  SANDBOX$IDLE_TIMEOUT_WARNING = "SANDBOX$IDLE_TIMEOUT_WARNING",
  NEON$API_KEY_LABEL = "NEON$API_KEY_LABEL",
}
