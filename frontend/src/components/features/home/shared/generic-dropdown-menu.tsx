...
export function GenericDropdownMenu<T>({
  ...
  return (
    <div className="relative">
      <div
        className={cn(
          "absolute z-10 w-full bg-tertiary border border-[#727987] rounded-lg shadow-none",
      ...
      >
                  ...
                  <React.Fragment key={key}>
                    ...
                    {numberOfRecentItems > 0 &&
                      index === numberOfRecentItems - 1 && (
                        <div className="border-b border-[#727987] bg-tertiary pb-1 mb-1 h-[1px]" />
                      )}
                  </React.Fragment>
                );
              })}
        ...
        {stickyFooterItem && (
          <div className="border-t border-[#727987] bg-tertiary p-1 rounded-b-lg">
            {stickyFooterItem}
          </div>
        )}
      </div>
